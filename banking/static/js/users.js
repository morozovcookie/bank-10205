...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserTable = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var users = this.props.Accounts.map(function (account) {
	            idx = idx + 1;
	            return React.createElement(UserRow, { key: idx, data: account.user });
	        });
	        return React.createElement(
	            'table',
	            { className: 'table', id: 'user-table' },
	            React.createElement(
	                'thead',
	                null,
	                React.createElement(
	        ...
	        $.ajax({
	            ...
	            success: function success(response) {
	                $.ajax({
	                    ...
	                    success: function success(response) {
	                        ReactDOM.render(React.createElement(UserTable, { Accounts: response }), document.getElementById('usertable'));
	                    }
	                });
	            }
	        });
	    },
	    handleUpdateUser: function handleUpdateUser(event) {
	        var id = $($($(event.currentTarget).parents()[1]).children()[0]).text();
	        ReactDOM.render(React.createElement(UpdateUserDlg, { Id: id }), document.getElementById('update-user'));
	    },
	    render: function render() {
	            ...
	            if (this.props.data.username === JSON.parse(window.localStorage.getItem('user')).username) {
	                return React.createElement(
	                    ...
	                    React.createElement(
	                        'td',
	                        null,
	                        React.createElement(UserModalAction, { ButtonClass: 'btn btn-warning', Icon: 'glyphicon glyphicon-edit', Target: '#update-user-dlg', Click: this.handleUpdateUser })
	                    )
	                );
	            }
	        }
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                null,
	                React.createElement(UserModalAction, { ButtonClass: 'btn btn-warning', Icon: 'glyphicon glyphicon-edit', Target: '#update-user-dlg', Click: this.handleUpdateUser }),
	                React.createElement(UserAction, { ButtonClass: 'btn btn-danger', Icon: 'glyphicon glyphicon-trash', Click: this.handleDeleteUser })
	            )
	        );
	    }
	});
	...
	var UserModalAction = React.createClass({
	    displayName: 'UserModalAction',

	    render: function render() {
	        return React.createElement(
	            'a',
	            { href: '#', className: this.props.ButtonClass, 'data-toggle': 'modal', 'data-target': this.props.Target, onClick: this.props.hasOwnProperty('Click') ? this.props.Click : '' },
	...
	var UserAction = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'a',
	            { href: '#', className: this.props.ButtonClass, onClick: this.props.hasOwnProperty('Click') ? this.props.Click : '' },
	            React.createElement('span', { className: this.props.Icon })
	        );
	    }
	});
	...
	var NewUserDlg = React.createClass({
	    ...
	    handleChangeUserStatus: function handleChangeUserStatus() {
	        this.setState({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'form',
	                    { className: 'form-horizontal', name: 'create-user-form' },
	                    React.createElement(
	                        'fieldset',
	                        null,
	                        React.createElement(Edit, { Label: 'Логин', Value: this.state.username, Type: 'text', LabelId: 'username-label', EditId: 'username-input', FormName: 'create-user-form', Change: this.handleUsernameChange }),
	                        React.createElement(Edit, { Label: 'Временный пароль', Value: this.state.password, Type: 'password', LabelId: 'temp-password-label', EditId: 'temp-password-input', FormName: 'create-user-form', Change: this.handlePasswordChange }),
	                        React.createElement(Edit, { Label: 'Имя', Type: 'text', Value: this.state.first_name, LabelId: 'user-firstname-label', EditId: 'user-firstname-input', FormName: 'create-user-form', Change: this.handleFirstnameChange }),
	                        React.createElement(Edit, { Label: 'Фамилия', Type: 'text', Value: this.state.last_name, LabelId: 'user-secondname-label', EditId: 'user-secondname-input', FormName: 'create-user-form', Change: this.handleLastnameChange }),
	                        React.createElement(Checkbox, { Id: 'is-superuser-checkbox', Change: this.handleChangeUserStatus, IconClass: 'glyphicon glyphicon-briefcase', Caption: 'Суперпользователь' })
	                    )
	                )
	            ),
	            React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'col-md-4' },
	                    React.createElement(OKButton, { Link: '#', Class: 'btn btn-success', Id: 'add-user-button', Caption: 'Добавить', Click: this.handleAddUser })
	                )
	            )
	        );
	    }
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'col-md-1' },
	                React.createElement('input', { type: 'checkbox', id: this.props.Id, onChange: this.props.Change })
	            ),
	            React.createElement(
	                'div',
	                { className: 'col-md-1' },
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'button',
	                    { type: 'button', className: 'close', 'data-dismiss': 'modal', 'aria-hidden': 'true', onClick: function onClick() {
	                            $('#update-user').empty();
	                        } },
	                    'x'
	                ),
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'form',
	                    { className: 'form-horizontal', name: 'update-user-form' },
	                    React.createElement(
	                        'fieldset',
	                        null,
	                        React.createElement(Edit, { Label: 'Логин', Value: this.state.username, Type: 'text', LabelId: 'username-label', EditId: 'username-input', FormName: 'update-user-form', Change: this.handleUsernameChange }),
	                        React.createElement(Edit, { Label: 'Временный пароль', Type: 'password', LabelId: 'temp-password-label', EditId: 'temp-password-input', FormName: 'update-user-form', Change: this.handlePasswordChange }),
	                        React.createElement(Edit, { Label: 'Имя', Type: 'text', Value: this.state.first_name, LabelId: 'user-firstname-label', EditId: 'user-firstname-input', FormName: 'update-user-form', Change: this.handleFirstnameChange }),
	                        React.createElement(Edit, { Label: 'Фамилия', Type: 'text', Value: this.state.last_name, LabelId: 'user-secondname-label', EditId: 'user-secondname-input', FormName: 'update-user-form', Change: this.handleLastnameChange }),
	                        React.createElement(Checkbox, { Id: 'is-superuser-checkbox', Change: this.handleChangeUserStatus, IconClass: 'glyphicon glyphicon-briefcase', Caption: 'Суперпользователь' })
	                    )
	                )
	            ),
	            React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'col-md-4' },
	                    React.createElement(OKButton, { Link: '#', Class: 'btn btn-success', Id: 'update-user-button', Caption: 'Сохранить', Click: this.handleUpdateUser })
	                )
	            )
	        );
	    }
	...
	var OKButton = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'a',
	            { href: this.props.Link, className: this.props.Class, id: this.props.Id, 'data-dismiss': 'modal',
	...
	ReactDOM.render(React.createElement(NewUserDlg, null), document.getElementById('new-user'));
	...
	$('#update-user').click(function (event) {
	    if ($(event.target) == this) $('#update-user').empty();
	});
