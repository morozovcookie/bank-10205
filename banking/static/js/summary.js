...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserRow = function (_React$Component) {
	    ...
	    function UserRow() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(UserRow).apply(this, arguments));
	    }

	    _createClass(UserRow, [{
	        key: 'render',
	        value: function render() {
	            var styles = { margin: "1rem" };
	            var events = this.props.user.debts.map(function (e) {
	...
	var EventsRow = function (_React$Component2) {
	    _inherits(EventsRow, _React$Component2);

	    function EventsRow() {
	        _classCallCheck(this, EventsRow);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(EventsRow).apply(this, arguments));
	    }

	    _createClass(EventsRow, [{
	        key: 'render',
	        value: function render() {
	            var _this3 = this;
	...
	var Summary = function (_React$Component3) {
	    _inherits(Summary, _React$Component3);
	    ...
	    _createClass(Summary, [{
	        key: 'render',
	        value: function render() {
	            var events_count = this.props.events.length;

	            var users = this.props.users.map(function (u) {
	                return _react2.default.createElement(UserRow, { key: u.id, user: u });
	            });
	            return _react2.default.createElement(
	                'table',
	                { className: 'table' },
	...
	_reactDom2.default.render(_react2.default.createElement(Summary, { users: dummy.users, events: dummy.events }), document.getElementById('summary'));
	// $.get('/api/summary/')
	// .done((data) => {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/home/intey/projects/bank-10205/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "summary.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
