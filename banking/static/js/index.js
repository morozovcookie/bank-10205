...
/***/ function(module, exports, __webpack_require__) {
	...
	var MenuList = React.createClass({
	    ...
	    render: function render() {
	        ...
	        if (JSON.parse(user).is_superuser) {
	            return React.createElement(
	                'ul',
	                { className: 'nav nav-pills nav-stacked', id: 'nav-menu' },
	                React.createElement(MenuListItem, { IconClass: 'glyphicon glyphicon-home', Caption: 'Главная', Link: '/admin/' }),
	                React.createElement(MenuListItem, { IconClass: 'glyphicon glyphicon-user', Caption: 'Сотрудники', Link: '/users/' }),
	                React.createElement(MenuListItem, { IconClass: 'glyphicon glyphicon-list-alt', Caption: 'События', Link: '/events/' }),
	                React.createElement(MenuListItem, { IconClass: 'glyphicon glyphicon-duplicate', Caption: 'Шаблоны событий', Link: '/templates/' })
	            );
	        }
	        return React.createElement(
	            'ul',
	            { className: 'nav nav-pills nav-stacked', id: 'nav-menu' },
	            React.createElement(MenuListItem, { IconClass: 'glyphicon glyphicon-home', Caption: 'Главная', Link: '/client/' }),
	            React.createElement(MenuListItem, { IconClass: 'glyphicon glyphicon-list-alt', Caption: 'События', Link: '/events/' })
	        );
	    }
	});
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(NavbarMenuList, null)
	                )
	            )
	        );
	    }
	...
	var NavbarMenuList = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(NavbarMenuListBadgeItem, { Link: '#', Content: 'Баланс банка' }),
	            React.createElement(NavbarMenuListItem, { Link: '#', Content: 'Выход', click: this.logout })
	        );
	    }
	});

	var NavbarMenuListItem = React.createClass({
	    displayName: 'NavbarMenuListItem',
	...
	var NavbarMenuListBadgeItem = React.createClass({
	    displayName: 'NavbarMenuListBadgeItem',
	...
	ReactDOM.render(React.createElement(NavMenu, null), document.getElementById('nav'));
