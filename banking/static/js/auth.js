...
/***/ function(module, exports, __webpack_require__) {
	...
	var AuthForm = React.createClass({
	    ...
	    handleAuth: function handleAuth() {
	        $.post('/api/auth/', this.state).success(function (response) {
	    ...
	    render: function render() {
	        return React.createElement(
	            'form',
	            { className: 'form-horizontal', name: 'auth-form', method: 'post' },
	            React.createElement(
	                'fieldset',
	                null,
	                React.createElement(
	                ...
	                React.createElement(Edit, { label: 'Username', type: 'text', change: this.handleUsernameChange }),
	                React.createElement(Edit, { label: 'Password', type: 'password', change: this.handlePasswordChange }),
	                React.createElement(Button, { caption: 'Войти', click: this.handleAuth })
	            )
	        );
	    }
	});
	...
	var Edit = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'span',
	                { className: 'input-group-addon', id: 'username-label' },
	                this.props.label
	            ),
	            React.createElement('input', { type: this.props.type, className: 'form-control', id: 'username-input',
	...
	var Button = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'button',
	                { type: 'button', className: 'btn btn-success col-md-12',
	...
	ReactDOM.render(React.createElement(AuthForm, null), document.getElementById('auth-panel'));
