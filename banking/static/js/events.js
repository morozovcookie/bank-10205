...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/home/intey/projects/bank-10205/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/home/intey/projects/bank-10205/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var EventTable = __webpack_require__(163);

	var CreateEventDlg = React.createClass({
	    displayName: 'CreateEventDlg',
	    ...
	    handleSumChange: function handleSumChange(event) {
	        this.setState({
	    ...
	    handleTemplateChange: function handleTemplateChange(event) {
	        this.setState({
	            template: $($(event.currentTarget).children()[0]).html()
	        });
	    },
	    handleGoToEventBuilder: function handleGoToEventBuilder() {
	        ReactDOM.render(React.createElement(EventBuilder, { BaseInformation: this.state }), document.getElementById('event-block'));
	    },
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'form',
	                            { className: 'form-horizontal', name: 'main-event-info', method: 'post' },
	                            React.createElement(
	                                'fieldset',
	                                null,
	                                React.createElement(TemplateDropdown, { Id: 'template-title-btn', Value: this.state.template, Change: this.handleTemplateChange, Caption: 'Шаблон', FormName: 'main-event-info', DropdownList: templates }),
	                                React.createElement(Dropdown, { Id: 'event-type-title-btn', Value: this.state.type, Change: this.handleTypeChange, Caption: 'Тип', FormName: 'main-event-info', DropdownList: events }),
	                                React.createElement(Edit, { Label: 'Название', Type: 'text', Value: this.state.title, LabelId: 'event-title-label', EditId: 'event-title-input', FormName: 'main-event-info', Change: this.handleTitleChange }),
	                                React.createElement(Edit, { Label: 'Дата', Type: 'date', Value: this.state.date, LabelId: 'event-date-label', EditId: 'event-date-input', FormName: 'main-event-info', Change: this.handleDateChange }),
	                                React.createElement(Edit, { Label: 'Сумма', Type: 'text', Value: this.state.sum, LabelId: 'event-sum-label', EditId: 'event-sum-input', FormName: 'main-event-info', Change: this.handleSumChange })
	                            )
	                        )
	                    ),
	                    React.createElement('div', { className: 'col-md-2' })
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'col-md-3' },
	                    React.createElement(CloseDlgButton, { Link: '#', Class: 'btn btn-success', Id: 'next-step-button', Caption: 'Создать', Click: this.handleGoToEventBuilder })
	                )
	            )
	        );
	    }
	...
	var EventBuilder = React.createClass({
	    ...
	    getInitialState: function getInitialState() {
	        return {
	            ...
	            participants: [{
	                ...
	                fullname: JSON.parse(window.localStorage.getItem('user')).last_name + ' ' + JSON.parse(window.localStorage.getItem('user')).first_name
	            }],
	            fd: new FormData()
	        };
	    },
	    ...
	    handleSelectParticipant: function handleSelectParticipant(event) {
	        var participants = this.state.participants;
	        participants.push({
	            username: $($($(event.currentTarget).children()[1]).children()[0]).html(),
	            fullname: $($(event.currentTarget).children()[2]).html()
	        });
	        ReactDOM.render(React.createElement(ParticipantsTable, { Participants: this.state.participants, Click: this.handleRemoveParticipant }), document.getElementById('participant-table'));
	        $('#event-participants-input').val('');
	        $('#userauto').hide();
	    },
	    handleParticipantsChange: function handleParticipantsChange(event) {
	            ...
	            $.ajax({
	                ...
	                success: function success(response) {
	                    ...
	                    response.forEach(function (user) {
	                        ...
	                        if (!result) users.push(user);
	                    });
	                    ReactDOM.render(React.createElement(HintUserList, { Users: users, Click: eventBuilder.handleSelectParticipant }), document.getElementById('userautolist'));
	                    $('#userauto').show();
	                }
	            });
	        } else $('#userauto').hide();
	    },
	    handleHideUsersHint: function handleHideUsersHint() {
	        if (!$('#userautolist:hover').length) $('#userauto').hide();
	    },
	    handleChangeFile: function handleChangeFile(event) {
	    ...
	    handleAttachFileClick: function handleAttachFileClick() {
	        $('form[name="new-event-form"] input[type="file"]').trigger('click');
	    },
	    hadnleCancelClick: function hadnleCancelClick() {
	        document.location.href = '/events/';
	    },
	    hadnleCreateClick: function hadnleCreateClick() {
	    ...
	    handleRemoveParticipant: function handleRemoveParticipant(event) {
	        ...
	        participants.forEach(function (elem) {
	            if (JSON.stringify(elem) === participant) return;
	            ++idx;
	        }, this);
	    ...
	    handleChangeAccess: function handleChangeAccess(event) {
	    ...
	    render: function render() {
	        var events = ['Перевод', 'Пополнение', 'Списание'];
	        var owner = JSON.parse(window.localStorage.getItem('user')).last_name + ' ' + JSON.parse(window.localStorage.getItem('user')).first_name;
	        return React.createElement(
	            'div',
	            { className: 'col-md-12' },
	            React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'form',
	                        { className: 'form-horizontal', name: 'new-event-form', type: 'post', encType: 'multipart' },
	                        React.createElement(
	                            'fieldset',
	                            { style: { position: 'relative' } },
	                            React.createElement(Edit, { Label: 'Название', Type: 'text', Value: this.state.title, LabelId: 'event-title-label', EditId: 'event-title-input', FormName: 'new-event-form', Change: this.handleTitleChange }),
	                            React.createElement(Dropdown, { Id: 'event-type-btn', Value: this.state.type, Change: this.handleTypeChange, Caption: 'Тип', FormName: 'new-event-form', DropdownList: events }),
	                            React.createElement(Edit, { Label: 'Дата', Type: 'date', Value: this.state.date, LabelId: 'event-date-label', EditId: 'event-date-input', FormName: 'new-event-form', Change: this.handleDateChange }),
	                            React.createElement(Edit, { Label: 'Сумма', Type: 'text', Value: this.state.sum, LabelId: 'event-sum-label', EditId: 'event-sum-input', FormName: 'new-event-form', Change: this.handleSumChange }),
	                            React.createElement(
	                                'div',
	                                { className: 'row' },
	                                React.createElement('div', { className: 'col-md-1' }),
	                                React.createElement(
	                                    'label',
	                                    { className: 'col-md-3', form: 'new-event-form' },
	                                    'Создатель'
	                                ),
	                                React.createElement('div', { className: 'col-md-1' }),
	                                React.createElement(
	                                    'div',
	                                    { className: 'col-md-7', style: { padding: '10px' } },
	                                    owner
	                                )
	                            ),
	                            React.createElement(
	                                ...
	                                React.createElement(
	                                    'ul',
	                                    { id: 'access-event' },
	                                    React.createElement(AccessCheckbox, { IconClass: 'glyphicon glyphicon-book event-icon', AccessId: 'public', Header: 'Public', Caption: 'Данное событие будет видно всем', Change: this.handleChangeAccess }),
	                                    React.createElement(AccessCheckbox, { IconClass: 'glyphicon glyphicon-lock event-icon', AccessId: 'private', Header: 'Private', Caption: 'Данное событие будет видно только создателю и участникам', Change: this.handleChangeAccess })
	                                )
	                            ),
	                            React.createElement(Edit, { Label: 'Участники', Type: 'text', LabelId: 'event-participants-label', EditId: 'event-participants-input', FormName: 'new-event-form', Change: this.handleParticipantsChange, Blur: this.handleHideUsersHint, Focus: this.handleParticipantsChange }),
	                            React.createElement(
	                                'div',
	                                { className: 'row', id: 'userauto' },
	                                React.createElement('div', { className: 'col-md-3' }),
	                                React.createElement('div', { className: 'col-md-8', id: 'userautolist' }),
	                                React.createElement('div', { className: 'col-md-1' })
	                            ),
	                            React.createElement('div', { id: 'participant-table' }),
	                            React.createElement(
	                                'div',
	                                { className: 'row' },
	                                React.createElement(
	                                    'div',
	                                    { className: 'col-md-12' },
	                                    React.createElement('div', { id: 'files-list' })
	                                )
	                            ),
	                            React.createElement(
	                                'div',
	                                { className: 'button-group row', style: { paddingRight: '20px' } },
	                                React.createElement(Edit, { Type: 'file', LabelId: 'file-attach-label', Id: 'file-attach-input', FormName: 'new-event-form', Change: this.handleChangeFile }),
	                                React.createElement(Button, { Link: '#', Class: 'btn btn-default', Id: 'attach-file-button', Icon: 'glyphicon glyphicon-paperclip', Caption: 'Прикрепить файл', Click: this.handleAttachFileClick })
	                            ),
	                            React.createElement(
	                                'div',
	                                { className: 'button-group row', style: { paddingRight: '20px' } },
	                                React.createElement(Button, { Link: '#', Class: 'btn btn-danger', Id: 'cancel-event-button', Icon: 'glyphicon glyphicon-thumbs-down', Caption: 'Отменить', Click: this.hadnleCancelClick }),
	                                React.createElement(Button, { Link: '#', Class: 'btn btn-success', Id: 'save-event-button', Icon: 'glyphicon glyphicon-thumbs-up', Caption: 'Создать', Click: this.hadnleCreateClick })
	                            )
	                        )
	                    )
	                ),
	...
	var HintUserList = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var users = this.props.Users.map(function (user) {
	            idx = idx + 1;
	            return React.createElement(HintUserRow, { key: idx, data: user, Click: this.props.Click });
	        }, this);
	        return React.createElement(
	            'div',
	...
	var ParticipantsTable = React.createClass({
	    displayName: 'ParticipantsTable',

	    render: function render() {
	        var idx = 0;
	        var participants = this.props.Participants.map(function (participant) {
	            idx = idx + 1;
	            return React.createElement(ParticipantRow, { key: idx, data: participant, Id: idx, Click: this.props.Click });
	        }, this);
	        return React.createElement(
	            'table',
	            { className: 'table' },
	        ...
	        if (this.props.Id == 1) {
	            return React.createElement(
	                ...
	                React.createElement(
	                    'td',
	                    null,
	                    React.createElement('input', { type: 'text', className: 'form-control', id: 'part', defaultValue: '0.0' })
	                ),
	                React.createElement(
	                    'td',
	                    null,
	                    React.createElement('input', { type: 'text', className: 'form-control', id: 'sum', defaultValue: '0.0', readOnly: true })
	                )
	            );
	        }
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'a',
	                    { href: '#', className: 'btn btn-danger', onClick: this.props.Click },
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'col-md-1' },
	                React.createElement('input', { type: 'checkbox', id: this.props.AccessId, onChange: this.props.Change })
	            ),
	            React.createElement(
	                'div',
	                { className: 'col-md-1' },
	...
	var Dropdown = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var dropdown_list = this.props.DropdownList.map(function (item) {
	            idx = idx + 1;
	            return React.createElement(DropdownItem, { key: idx, data: item, Click: this.props.Change });
	        }, this);
	        return React.createElement(
	            'div',
	            { className: 'row' },
	            ...
	            React.createElement(
	                'label',
	                { className: 'col-md-3', form: this.props.FormName },
	                this.props.Caption
	            ),
	            React.createElement(
	                'div',
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'button',
	                        { type: 'button', className: 'btn btn-default', id: this.props.Id },
	                        this.props.Value
	                    ),
	                    React.createElement(
	                        'button',
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'ul',
	                        { className: 'dropdown-menu' },
	                        React.createElement(DropdownItem, { key: idx, data: 'Без шаблона' }),
	...
	var Edit = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'span',
	                { className: 'input-group-addon', id: this.props.LabelId },
	                this.props.Label
	            ),
	            React.createElement('input', { type: this.props.Type, className: 'form-control', id: this.props.EditId, value: this.props.Value,
	...
	var CloseDlgButton = React.createClass({
	    displayName: 'CloseDlgButton',

	    render: function render() {
	        return React.createElement(
	            'a',
	            { href: this.props.Link, className: this.props.Class, id: this.props.Id, onClick: this.props.Click, 'data-dismiss': 'modal', 'aria-hidden': 'true' },
	...
	var Button = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'a',
	            { href: this.props.Link, className: this.props.Class, id: this.props.Id, onClick: this.props.Click },
	...
	ReactDOM.render(React.createElement(CreateEventDlg, null), document.getElementById('create-event'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var events = this.props.events.map(function (event) {
	            idx = idx + 1;
	            return React.createElement(EventRow, { key: idx, data: event });
	        });
	        return React.createElement(
	            'table',
	            { className: 'table', id: 'event-table' },
	            React.createElement(
	                'thead',
	                null,
	                React.createElement(
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/home/intey/projects/bank-10205/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "eventtable.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
